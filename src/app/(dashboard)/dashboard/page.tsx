              ...
              <div className="divide-y divide-hairline-light">
                {docs.slice(0, 8).map((d) => (
                  <Link
                    ...
                    className="flex items-center gap-3 px-4 md:px-5 py-2.5 hover:bg-surface/50 transition-colors"
                  >
                    <span className="text-xs font-mono font-bold text-brand flex-shrink-0">
                      {d.document_number}
                    </span>
