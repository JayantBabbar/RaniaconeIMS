...
export const PARTIES = [
  ...
  { id: "party-1", tenant_id: TENANTS[0].id, code: "SUP-001", name: "Kaizen Imports",     legal_name: "Kaizen Imports Pvt Ltd",   tax_id: "27AAAAA0001A1Z5", party_type: "supplier", opening_balance: "45000.00", currency_id: "cur-inr", is_gst_registered: true,  gstin: "27AAAAA0001A1Z5", state_code: "27", description: "Primary electronics importer",         is_active: true, created_at: iso(100), updated_at: iso(100) },
